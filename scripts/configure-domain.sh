...
function run-append() {
    ...
    append "127.0.0.1 org1-store1.gateway.com" "$file"
    append "127.0.0.1 org1-store2.gateway.com" "$file"
    append "127.0.0.1 org2-store1.gateway.com" "$file"
    append "127.0.0.1 org2-store2.gateway.com" "$file"
}
