...
insert into router.reference(id, reference, reference_type, enabled, pod_id)
values ('65f023632bc46470c204b76f', 'reference', 'STORE', true, '65f023632bc46470c204b78f') on conflict do nothing;
