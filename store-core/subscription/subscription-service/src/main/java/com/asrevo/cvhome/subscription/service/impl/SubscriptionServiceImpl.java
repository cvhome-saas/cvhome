...
public class SubscriptionServiceImpl implements SubscriptionService {
    ...
    public Optional<SubscriptionPlanDetails> subscriptionPlanDetails(ManagerOrgId org) {
        return subscriptionRepository.findById(org)
    ...
    @Transactional
    @Override
    public void renew(ManagerOrgId org, SubscriptionPlan subscriptionPlan, Instant startDate, Instant endDate, RecurringPlan recurringPlan) {
        subscriptionRepository.findById(org)
