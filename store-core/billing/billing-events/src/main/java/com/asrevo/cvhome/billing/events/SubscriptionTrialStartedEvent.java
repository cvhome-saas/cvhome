...
public record SubscriptionTrialStartedEvent(ManagerStoreId store, ManagerOrgId org, Map<String, String> data)
        implements SubscriptionEvent {

    public static SubscriptionTrialStartedEvent from(ManagerStoreId store, ManagerOrgId org) {
        return new SubscriptionTrialStartedEvent(store, org, Map.of());
    }

    public static SubscriptionTrialStartedEvent from(ManagerStoreId store, ManagerOrgId org, Map<String, String> data) {
