...
public record InvoiceRecordedEvent(ManagerStoreId store, ManagerOrgId org, Map<String, String> data)
        implements SubscriptionEvent {

    public static InvoiceRecordedEvent from(ManagerStoreId store, ManagerOrgId org) {
        return new InvoiceRecordedEvent(store, org, Map.of());
    }

    public static InvoiceRecordedEvent from(ManagerStoreId store, ManagerOrgId org, Map<String, String> data) {
