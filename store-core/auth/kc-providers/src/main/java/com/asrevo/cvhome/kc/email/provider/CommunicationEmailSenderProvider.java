...
public class CommunicationEmailSenderProvider implements EmailSenderProvider {
    private static final org.jboss.logging.Logger log = Logger.getLogger(CommunicationEmailSenderProvider.class);
    private static final String realmName = "cvhome";
    private final CommunicationService communicationService;
    private final AccessTokenGenerator tokenGenerator;
    private String accessToken = null;

    CommunicationEmailSenderProvider(KeycloakSession session, CommunicationService communicationService) {
    ...
    private TokenInterceptor buildTokenInterceptor() {
        return new TokenInterceptor() {
            ...
            public String getAccessToken() {
                if (accessToken == null) {
                    CommunicationEmailSenderProvider.this.accessToken = CommunicationEmailSenderProvider.this.tokenGenerator.generate();
                }
                return accessToken;
            }
        };
