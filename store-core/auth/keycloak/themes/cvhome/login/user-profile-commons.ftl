<#macro userProfileFormFields>
    ...
    <#list profile.attributes as attribute>
        ...
        >
                ...
                <div :class="kcMultivalued ? 'pf-v5-c-input-group' : ''">
					...
					<span class="${properties.kcInputClass!}">
						<#if attribute.annotations.inputHelperTextBefore??>
                            <div class="${properties.kcInputHelperTextBeforeClass!}"
            ...
            <button type="button" class="pf-v5-c-button pf-m-link" x-show="kcMultivalued"
                    x-on:click="values.push({ value: '' }); $dispatch('bind')" id="kc-add-${attribute.name}">
...
<#macro inputTag attribute value>
    <input type="<@inputTagType attribute=attribute/>"
           :id="kcMultivalued ? $id('${attribute.name}') : '${attribute.name}'" name="${attribute.name}"
           :value="item.value" class="${properties.kcInputClass!}"
