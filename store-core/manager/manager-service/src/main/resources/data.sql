...
INSERT INTO manager.manager_store(id, name, created_date, org_id, pod_id, provisioning_state, preferences, version)
VALUES ('65f023632bc46470c104b76f', 'ORG1-STORE1', CURRENT_DATE, '21f023932bc66470c104b76f', '1',
        'SUCCESSFULLY_PROVISIONING',
        '{"theme":"DEFAULT","defaultLanguage":{"code":"ar"},"supportedLanguages":[{"code":"ar"},{"code":"en"}]}', 1)
ON CONFLICT DO NOTHING;

INSERT INTO manager.manager_store(id, name, created_date, org_id, pod_id, provisioning_state, preferences, version)
VALUES ('65f023632bc46470c104b75f', 'ORG1-STORE2', CURRENT_DATE, '21f023932bc66470c104b76f', '1',
        'SUCCESSFULLY_PROVISIONING',
        '{"theme":"DEFAULT","defaultLanguage":{"code":"en"},"supportedLanguages":[{"code":"en"},{"code":"fr"}]}', 1)
ON CONFLICT DO NOTHING;

INSERT INTO manager.manager_store(id, name, created_date, org_id, pod_id, provisioning_state, preferences, version)
VALUES ('65f020632bc46470c104b76f', 'ORG2-STORE1', CURRENT_DATE, '352023632b046970c104b76f', '1',
        'SUCCESSFULLY_PROVISIONING',
        '{"theme":"DEFAULT","defaultLanguage":{"code":"fr"},"supportedLanguages":[{"code":"fr"},{"code":"en"}]}', 1)
ON CONFLICT DO NOTHING;

INSERT INTO manager.manager_store(id, name, created_date, org_id, pod_id, provisioning_state, preferences, version)
VALUES ('65f023632bc26470c104b75f', 'ORG2-STORE2', CURRENT_DATE, '352023632b046970c104b76f', '1',
        'SUCCESSFULLY_PROVISIONING',
        '{"theme":"DEFAULT","defaultLanguage":{"code":"ar"},"supportedLanguages":[{"code":"ar"},{"code":"fr"}]}', 1)
ON CONFLICT DO NOTHING;
