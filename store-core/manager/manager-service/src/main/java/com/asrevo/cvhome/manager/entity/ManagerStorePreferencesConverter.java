...
public class ManagerStorePreferencesConverter {
    @WritingConverter
    public static class ManagerStorePreferencesWrittingConverter
            implements Converter<ManagerStorePreferences, String> {
    ...
    @ReadingConverter
    public static class ManagerStorePreferencesReadingConverter
            implements Converter<String, ManagerStorePreferences> {
        private final ObjectMapper objectMapper = new ObjectMapper();
