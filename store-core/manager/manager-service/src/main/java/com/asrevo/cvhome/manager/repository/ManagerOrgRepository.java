...
public interface ManagerOrgRepository extends CrudRepository<ManagerOrgEntity, ManagerOrgId>, QueryByExampleExecutor<ManagerOrgEntity>, PagingAndSortingRepository<ManagerOrgEntity, ManagerOrgId> {
    @Query("""
