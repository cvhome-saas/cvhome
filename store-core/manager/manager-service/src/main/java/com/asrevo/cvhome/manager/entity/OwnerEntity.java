...
public class OwnerEntity extends BaseEntity<OwnerEntity, IdentityId> {
    ...
    private Set<OwnerStoreRefEntity> stores;
    ...
    public OwnerEntity addToStores(StoreId storeId) {
        if (this.stores == null || this.stores.isEmpty()) this.stores = new HashSet<>();
        OwnerStoreRefEntity ref = new OwnerStoreRefEntity();
        ref.setStore(AggregateReference.to(storeId));
        this.stores.add(ref);
        return this;
    }
}
