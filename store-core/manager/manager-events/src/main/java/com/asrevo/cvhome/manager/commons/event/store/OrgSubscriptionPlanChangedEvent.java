...
public record OrgSubscriptionPlanChangedEvent(ManagerOrgId org, Map<String, String> data)
        implements OrgEvent {
    public static OrgSubscriptionPlanChangedEvent from(
            ManagerOrgId org,
            SubscriptionPlan newSubscriptionPlan,
            SubscriptionPlan oldSubscriptionPlan) {
        return new OrgSubscriptionPlanChangedEvent(
                org,
                Map.of(
                        "newSubscriptionPlan",
                        newSubscriptionPlan.name(),
                        "oldSubscriptionPlan",
                        oldSubscriptionPlan.name()));
    }
