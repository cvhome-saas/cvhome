 ...
 *
 * Ported from console-ui, where two citations had rotted before it first ran: one quoted a heading
 * that had never been written, another quoted one that had been renamed. Both were silent — nothing
 * in lint or the specs looks at prose, and a lessons file nobody can trust is a lessons file nobody
 * reads.
 *
