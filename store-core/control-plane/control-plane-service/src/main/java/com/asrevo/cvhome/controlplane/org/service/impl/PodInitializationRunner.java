 ...
 * This replaces the static SQL INSERT for pods with dynamic runtime initialization. Uses
 * ApplicationReadyEvent to ensure the application is fully ready before initializing
 * pods.
 */
@Component
@AllArgsConstructor
