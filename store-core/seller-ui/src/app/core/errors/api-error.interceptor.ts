 ...
 * from the code:
 *
 * - `CrudService` is not the only HTTP client. `pages/shared/services/store.service.ts` and
 *   `pages/store-management/services/dns-check.service.ts` inject `HttpClient` directly and would silently
