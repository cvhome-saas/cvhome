...
export class ManagerStoreService {
  ...
  private readonly STORE_MANAGER_BASE_URL: string = '/tenancy/api/v1/store-manager';
   ...
   * "default" store. On a tenancy outage the seller silently got a store that does not exist, and
