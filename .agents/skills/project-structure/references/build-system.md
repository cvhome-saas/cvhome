...
| `com.asrevo.java-application-conventions` | every `-service`, `uaa`, `cua` | application/Spring Boot service setup, and the image itself: ECR registry, jlink, the JVM/native switch (`-Pnative`, see *Native images*) |
