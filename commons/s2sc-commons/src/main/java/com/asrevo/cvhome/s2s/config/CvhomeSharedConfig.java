...
@Configuration
@Import({EventProcessorConfig.class, CommandProcessorConfig.class, EcsInfoConfig.class, JacksonConfig.class, SwaggerConfig.class, WebConfig.class, WebClientServicesConfig.class})
