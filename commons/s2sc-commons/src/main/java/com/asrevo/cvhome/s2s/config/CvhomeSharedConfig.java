...
@EnableConfigurationProperties({ServiceDomainProperties.class, SaasProperties.class, CdnProperties.class, StoreProperties.class, StoreProductImageProperties.class})
