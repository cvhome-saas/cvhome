...
public record Challenges(List<Challenge> challenges) {
    ...
    public static List<Challenge> getChallenges(Order order) {
        ...
        if (dns01Challenge != null) {
            ...
            challenges.add(new com.asrevo.cvhome.commons.domain.challenges.Dns01Challenge(key, value));
        }
        ...
        if (http01Challenge != null) {
            ...
            challenges.add(new com.asrevo.cvhome.commons.domain.challenges.Http01Challenge(key, value));
        }
        ...
        if (tlsAlpn01Challenge != null) {
            ...
            challenges.add(new com.asrevo.cvhome.commons.domain.challenges.TlsAlpn01Challenge(domain, value));
        }
        return challenges;
    }
    ...
    @Transient
    @JsonIgnore
    public com.asrevo.cvhome.commons.domain.challenges.Dns01Challenge getDns01Challenge() {
        return (com.asrevo.cvhome.commons.domain.challenges.Dns01Challenge) getChallenge(Dns01);
    }

    @Transient
    @JsonIgnore
    public com.asrevo.cvhome.commons.domain.challenges.Http01Challenge getHttp01Challenge() {
        return (com.asrevo.cvhome.commons.domain.challenges.Http01Challenge) getChallenge(Http01);
    }

    @Transient
    @JsonIgnore
    public com.asrevo.cvhome.commons.domain.challenges.TlsAlpn01Challenge getTlsAlpn01Challenge() {
        return (com.asrevo.cvhome.commons.domain.challenges.TlsAlpn01Challenge) getChallenge(TlsAlpn01);
    }
