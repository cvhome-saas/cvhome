INSERT INTO orders.language (code, date_created, date_modified, updt_id, sort_order)
...
INSERT INTO orders.currency (currency_code, currency_name, currency_supported)
VALUES ('EUR', 'EUR', true)
on conflict do nothing;
INSERT INTO orders.currency (currency_code, currency_name, currency_supported)
VALUES ('EGP', 'EGP', true)
...
INSERT INTO orders.country (country_isocode, country_supported, geozone_id)
VALUES ('FR', true, null)
on conflict do nothing;
INSERT INTO orders.country (country_isocode, country_supported, geozone_id)
VALUES ('EG', true, null)
...
INSERT INTO orders.country_description (description_id, date_created, date_modified, updt_id, description, name, title,
