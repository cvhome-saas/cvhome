...
public interface OrderService extends SalesManagerEntityService<Long, Order> {
    ...
    OrderTotalSummary calculateShoppingCartTotal(
            ShoppingCart cartModel, Customer customer, StoreMerchantId store, LanguageCode language)
            throws ServiceException;

    OrderTotalSummary calculateShoppingCartTotal(
            ShoppingCart cartModel, StoreMerchantId store, LanguageCode language)
            throws ServiceException;
