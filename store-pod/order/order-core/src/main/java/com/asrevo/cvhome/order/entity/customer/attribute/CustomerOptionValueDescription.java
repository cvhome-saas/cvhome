...
@Entity
@Table(
        name = "CUSTOMER_OPT_VAL_DESCRIPTION",
        uniqueConstraints = {
            @UniqueConstraint(columnNames = {"CUSTOMER_OPT_VAL_ID", "LANGUAGE_CODE"})
        })
@TableGenerator(
        ...
        pkColumnValue = "CUSTOMER_OPTION_VALUE_DESCRIPTION_SEQ_NEXT_VAL",
