...
import com.asrevo.cvhome.order.entity.customer.CustomerGender;
...
import com.asrevo.cvhome.order.services.customer.attribute.CustomerOptionService;
import com.asrevo.cvhome.order.services.customer.attribute.CustomerOptionValueService;
...
public class CustomerPopulator
        extends AbstractDataPopulator<PersistableCustomer, StoreMerchantId, Customer> {
                ...
                if (source.getDelivery().getCountry().isValid()) {
                    ...
                    if (deliveryCountry == null) {
                        CountryIsoCode countryIsoCode =
                                Optional.ofNullable(sourceShipping)
