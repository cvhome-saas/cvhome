...
import com.asrevo.cvhome.order.model.order.total.ReadableTotal;
...
import com.asrevo.cvhome.order.service.mapper.customer.ReadableCustomerMapper;
import com.asrevo.cvhome.order.service.mapper.order.ReadableOrderProductMapper;
import com.asrevo.cvhome.order.service.mapper.order.ReadableOrderTotalMapper;
import com.asrevo.cvhome.order.service.populator.order.OrderProductPopulator;
import com.asrevo.cvhome.order.service.populator.order.PersistableOrderApiPopulator;
import com.asrevo.cvhome.order.service.populator.order.ReadableOrderPopulator;
import com.asrevo.cvhome.order.service.populator.order.ReadableOrderProductPopulator;
import com.asrevo.cvhome.order.service.populator.order.transaction.PersistablePaymentPopulator;
import com.asrevo.cvhome.order.services.order.OrderService;
...
public class OrderFacadeImpl implements OrderFacade {
    ...
    @Override
    public ReadableOrder getReadableOrder(
    ...
    public List<ReadableOrderStatusHistory> getReadableOrderHistory(
        ...
        if (order == null) {
            throw new ResourceNotFoundException(
                    "Order id [" + orderId + "] not found for merchand [" + store + "]");
        }
    ...
    public void createOrderStatus(
            PersistableOrderStatusHistory status, Long id, StoreMerchantId store) {
