...
public class CustomerFacadeImpl implements CustomerFacade {
    ...
    public CustomerFacadeImpl(
            CustomerService customerService, CustomerPopulator customerPopulator) {
    ...
    public ReadableCustomer getCustomerById(
            Long id, final StoreMerchantId store, final LanguageCode language) {
    ...
    private ReadableCustomerList convertCustomerListToReadableCustomerList(
            CustomerList customerList, StoreMerchantId store, LanguageCode language) {
        ...
        readableCustomerList.setTotalPages((int) Math.ceil((double) customerList.getTotalCount() / readableCustomerList.getSize()));

        return readableCustomerList;
    }

    private ReadableCustomer convertCustomerToReadableCustomer(
            Customer customer, StoreMerchantId store, LanguageCode language) {
