...
public class ReadableCustomerPopulator
        extends AbstractDataPopulator<Customer, StoreMerchantId, ReadableCustomer> {

    @Override
    public ReadableCustomer populate(
            Customer source, ReadableCustomer target, StoreMerchantId store, LanguageCode language)
