...
create table if not exists cua.oauth2_registered_client
(
...
create table if not exists cua.oauth2_authorization
(
    id                            varchar(100) primary key,
    ...
    foreign key (registered_client_id) references cua.oauth2_registered_client (id)
);

-- oauth2_authorization_consent
create table if not exists cua.oauth2_authorization_consent
(
    registered_client_id varchar(100)  not null,
    principal_name       varchar(200)  not null,
