-- Demo store 3: the realm, its policy, one shopper and the providers it brokers.
--
...
insert into cua.realms (id, display_name) values ('65f023632bc46470c104b75f', 'Demo store 3')
...
values ('65f023632bc46470c104b75f', 'Demo store 3', true)
...
values ('318F2FD5-E235-4C2E-AB7E-6C949BA4CDD3', '65f023632bc46470c104b75f', 'user', 'user@mail.com', 'user', 'user',
...
values ('65f023632bc46470c104b75f', '65f023632bc46470c104b75f', now(), null, 'Storefront',
