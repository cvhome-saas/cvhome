-- Demo store 2: the realm, its policy, one shopper and the providers it brokers.
--
...
insert into cua.realms (id, display_name) values ('65f023632bc26470c104b75f', 'Demo store 2')
...
values ('65f023632bc26470c104b75f', 'Demo store 2', true)
...
values ('318F2FD5-E235-4C2E-AB7E-6C949BA4CDD2', '65f023632bc26470c104b75f', 'user', 'user@mail.com', 'user', 'user',
...
values
    (gen_random_uuid(), '65f023632bc26470c104b75f', 'google', 'Google', 'OIDC', 'GOOGLE', true, false, 0,
    ...
    (gen_random_uuid(), '65f023632bc26470c104b75f', 'github', 'GitHub', 'OAUTH2', 'GITHUB', true, false, 1,
     ...
     'CONFIRM', true, true, now(), now()),
    (gen_random_uuid(), '65f023632bc26470c104b75f', 'facebook', 'Facebook', 'OAUTH2', 'FACEBOOK', true, false, 2,
     'facebook-app-id-2',
     'facebook-secret-2',
     'CONFIRM', true, true, now(), now())
...
values ('65f023632bc26470c104b75f', '65f023632bc26470c104b75f', now(), null, 'Storefront',
