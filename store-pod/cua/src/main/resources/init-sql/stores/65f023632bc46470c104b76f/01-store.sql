-- Demo store 4: the realm, its policy, one shopper and the providers it brokers.
--
...
insert into cua.realms (id, display_name) values ('65f023632bc46470c104b76f', 'Demo store 4')
...
values ('65f023632bc46470c104b76f', 'Demo store 4', true)
...
values ('318F2FD5-E235-4C2E-AB7E-6C949BA4CDD4', '65f023632bc46470c104b76f', 'user', 'user@mail.com', 'user', 'user',
...
values
    (gen_random_uuid(), '65f023632bc46470c104b76f', 'google', 'Google', 'OIDC', 'GOOGLE', true, false, 0,
    ...
    (gen_random_uuid(), '65f023632bc46470c104b76f', 'github', 'GitHub', 'OAUTH2', 'GITHUB', true, false, 1,
     ...
     'CONFIRM', true, true, now(), now()),
    (gen_random_uuid(), '65f023632bc46470c104b76f', 'facebook', 'Facebook', 'OAUTH2', 'FACEBOOK', true, false, 2,
     'facebook-app-id-4',
     'facebook-secret-4',
     'CONFIRM', true, true, now(), now())
...
values ('65f023632bc46470c104b76f', '65f023632bc46470c104b76f', now(), null, 'Storefront',
