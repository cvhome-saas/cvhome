...
import com.asrevo.cvhome.cua.exception.ForbiddenOperationException;
import com.asrevo.cvhome.cua.exception.ResourceNotExistException;
...
public class GeneralExceptionHandler {
    ...
    public ProblemDetail handleException(Exception e) {
        log.error("handle Internal Server Error", e);
