...
public class OrderTotal extends SalesManagerEntity<Long, OrderTotal> {
    ...
    @SequenceGenerator(name = "sales_order_total_seq", sequenceName = "sales_order_total_seq",
            allocationSize = SchemaConstant.ID_ALLOCATION_SIZE)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "sales_order_total_seq")
    private Long id;
