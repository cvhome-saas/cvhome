package com.asrevo.cvhome.checkout.entity.customer.attribute;
...
@Table(name = "CUSTOMER_OPTION_SET",
		uniqueConstraints = { @UniqueConstraint(columnNames = { "CUSTOMER_OPTION_ID", "CUSTOMER_OPTION_VALUE_ID" }) })
@Getter
@Setter
public class CustomerOptionSet extends SalesManagerEntity<Long, CustomerOptionSet> {
	...
	@TableGenerator(name = "TABLE_GEN", table = "SM_SEQUENCER", pkColumnName = "SEQ_NAME",
			valueColumnName = "SEQ_COUNT", pkColumnValue = "CUSTOMER_OPTION_SET_SEQ_NEXT_VAL",
