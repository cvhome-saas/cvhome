...
public class ProductVariantGroupApi {
    ...
    public @ResponseBody ReadableProductVariantGroup get(
            @PathVariable Long id, @Parameter(hidden = true) @SecuredResource StoreMerchantId merchantStore,
            @Parameter(hidden = true) LanguageCode language) {
    ...
    public @ResponseBody void delete(@PathVariable Long id, @Parameter(hidden = true) @SecuredResource StoreMerchantId merchantStore,
                                     @Parameter(hidden = true) LanguageCode language) {
...
/*
    ...
    public void removeImage(@PathVariable Long id, @PathVariable Long imageId, @Parameter(hidden = true) @SecuredResource StoreMerchantId merchantStore,
                            @Parameter(hidden = true) LanguageCode language) {
