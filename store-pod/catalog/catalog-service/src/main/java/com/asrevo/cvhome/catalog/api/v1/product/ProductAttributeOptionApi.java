...
public class ProductAttributeOptionApi {
    ...
    public @ResponseBody ReadableProductOptionEntity createOption(
            @Valid @RequestBody PersistableProductOptionEntity option, @Parameter(hidden = true) @SecuredResource StoreMerchantId merchantStore,
    ...
    public @ResponseBody ReadableProductOptionValue createOptionValue(
        ...
        return productOptionFacade.saveOptionValue(optionValue,
    ...
    */
    ...
    @ResponseBody
    public ReadableProductOptionEntity getOption(@PathVariable Long id, @Parameter(hidden = true) @SecuredResource StoreMerchantId merchantStore,
                                                 @Parameter(hidden = true) LanguageCode language) {
    ...
    @ResponseBody
    public ReadableProductOptionValue getOptionValue(@PathVariable Long id, @Parameter(hidden = true) @SecuredResource StoreMerchantId merchantStore,
                                                     @Parameter(hidden = true) LanguageCode language) {
    ...
    public void deleteOption(@PathVariable Long optionId, @Parameter(hidden = true) @SecuredResource StoreMerchantId merchantStore) {
    ...
    public void deleteAttribute(@PathVariable Long id, @PathVariable Long attributeId, @Parameter(hidden = true) @SecuredResource StoreMerchantId merchantStore) {
