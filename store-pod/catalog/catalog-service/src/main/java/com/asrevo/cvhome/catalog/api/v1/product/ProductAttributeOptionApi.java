...
public class ProductAttributeOptionApi {
	...
	public @ResponseBody ReadableProductOptionEntity createOption(
			@Valid @RequestBody PersistableProductOptionEntity option, @SecuredResource StoreMerchantId merchantStore,
	...
	@Parameters({
			...
			@Parameter(name = "lang",
					schema = @Schema(name = "lang", type = "string", defaultValue = Constants.DEFAULT_LANGUAGE)) })
	@ResponseBody
	public ReadableProductOptionEntity getOption(@PathVariable Long id, @SecuredResource StoreMerchantId merchantStore,
			LanguageCode language) {
	...
	@Parameters({ @Parameter(name = "store",
			schema = @Schema(name = "store", type = "string", defaultValue = DEFAULT_ORG1_STORE1_STR)) })
	public void deleteOption(@PathVariable Long optionId, @SecuredResource StoreMerchantId merchantStore) {
	...
	@Parameters({ @Parameter(name = "store",
			schema = @Schema(name = "store", type = "string", defaultValue = DEFAULT_ORG1_STORE1_STR)) })
	public void deleteOptionValue(@PathVariable Long id, @SecuredResource StoreMerchantId merchantStore) {
	...
	@Parameters({
			...
			@Parameter(name = "lang",
					schema = @Schema(name = "lang", type = "string", defaultValue = Constants.DEFAULT_LANGUAGE)) })
	public @ResponseBody ReadableProductOptionList options(@SecuredResource StoreMerchantId merchantStore,
			LanguageCode language, @RequestParam(value = "name", required = false) String name, Pageable pageable) {
	...
	@Parameters({
			...
			@Parameter(name = "lang",
					schema = @Schema(name = "lang", type = "string", defaultValue = Constants.DEFAULT_LANGUAGE)) })
	public @ResponseBody ReadableProductOptionValueList optionsValues(@SecuredResource StoreMerchantId merchantStore,
			LanguageCode language, @RequestParam(value = "name", required = false) String name, Pageable pageable) {
	...
	public @ResponseBody ReadableProductAttributeEntity getAttribute(@PathVariable Long id,
			@PathVariable Long attributeId, @SecuredResource StoreMerchantId merchantStore, LanguageCode language) {
	...
	public @ResponseBody Entity createAttribute(@PathVariable Long id,
			@Valid @RequestBody PersistableProductAttribute attribute, @SecuredResource StoreMerchantId merchantStore,
			LanguageCode language) {
