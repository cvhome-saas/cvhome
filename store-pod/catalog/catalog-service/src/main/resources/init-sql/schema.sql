...
create index if not exists prd_avail_store_prd_idx on catalog.product_availability (product_id, store_merchant_id);
create index if not exists prd_avail_prd_idx on catalog.product_availability (product_id);
