...
public class ReadableProductOptionSetMapper implements Mapper<ProductOptionSet, ReadableProductOptionSet> {
    ...
    @Override
    public ReadableProductOptionSet convert(ProductOptionSet source, StoreMerchantId store, LanguageCode language) {
    ...
    private ReadableProductType productType(ProductType type, StoreMerchantId store, LanguageCode language) {
