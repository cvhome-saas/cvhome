...
public class PersistableProductOptionSetMapper implements Mapper<PersistableProductOptionSet, ProductOptionSet> {
	...
	public PersistableProductOptionSetMapper(ProductOptionService productOptionService,
			ProductOptionValueService productOptionValueService, ProductTypeService productTypeService) {
	...
	@Override
	public ProductOptionSet convert(PersistableProductOptionSet source, StoreMerchantId store, LanguageCode language) {
