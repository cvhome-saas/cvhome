...
public class PersistableProductOptionValueMapper
    ...
    public ProductOptionValue merge(
        ...
        try {
            ...
            if (!CollectionUtils.isEmpty(source.getDescriptions())) {
                for (com.asrevo.cvhome.catalog.model.product.attribute.ProductOptionValueDescription
    ...
    public ProductOptionValue convert(
            PersistableProductOptionValue source, StoreMerchantId store, LanguageCode language) {
