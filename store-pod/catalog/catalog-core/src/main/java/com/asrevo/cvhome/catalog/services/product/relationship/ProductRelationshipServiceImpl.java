...
public class ProductRelationshipServiceImpl extends SalesManagerEntityServiceImpl<Long, ProductRelationship>
	...
	public int deleteRelationship(Product relatedProduct, String code, StoreMerchantId storeMerchantId) {
		return productRelationshipRepository
			.deleteAllByRelatedProduct_IdAndCodeAndStoreMerchantId(relatedProduct.getId(), code, storeMerchantId);
	}

	@Transactional
	@Override
	public int deleteRelationship(Product relatedProduct, Product product, String code,
			StoreMerchantId storeMerchantId) {
		return productRelationshipRepository.deleteAllByRelatedProduct_IdAndProduct_IdAndCodeAndStoreMerchantId(
	...
	@Override
	public List<ProductRelationship> getByType(StoreMerchantId store, Product product, String name,
			LanguageCode language) {
		return productRelationshipRepository.getByGroup(store, name, product, null, language);
	}

	@Override
	public List<ProductRelationship> getByType(StoreMerchantId store, String name, Product product, Product related,
			LanguageCode language) {
