...
@Entity
@Table(
        name = "PRODUCT_VAR_IMAGE_DESCRIPTION",
        uniqueConstraints = {
            @UniqueConstraint(columnNames = {"PRODUCT_VAR_IMAGE_ID", "LANGUAGE_CODE"})
        })
@TableGenerator(
        ...
        pkColumnValue = "PRODUCT_VARIANT_IMAGE_DESCRIPTION_SEQ_NEXT_VAL",
