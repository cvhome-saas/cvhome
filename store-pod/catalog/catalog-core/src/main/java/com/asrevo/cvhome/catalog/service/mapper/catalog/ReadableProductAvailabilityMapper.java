...
@Component
public class ReadableProductAvailabilityMapper
        implements Mapper<Product, ReadableProductAvailability> {
    @Override
    public ReadableProductAvailability convert(
    ...
    @Override
    public ReadableProductAvailability merge(
            Product source,
            ReadableProductAvailability destination,
        ...
        for (ProductAvailability availability : source.getAvailabilities()) {
            ...
            if (availability.getProductVariant() == null
