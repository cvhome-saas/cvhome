...
public class ProductPriceFacadeImpl implements ProductPriceFacade {
    ...
    public Long save(PersistableProductPrice price, StoreMerchantId store) {
        ...
        ProductPrice productPrice =
                persistableProductPriceMapper.convert(price, store, defaultLanguage);
    ...
    public List<ReadableProductPrice> list(
            String sku, Long inventoryId, StoreMerchantId store, LanguageCode language) {
                        ...
                        p -> {
                            try {
                                ...
                                throw new ServiceRuntimeException(
                                        "An exception occured while getting product price for sku ["
                                                + sku
                                                + "] and Store ["
                                                + store
                                                + "]",
    ...
    @Override
    public List<ReadableProductPrice> list(
            String sku, StoreMerchantId store, LanguageCode language) {
        Assert.notNull(store, "store cannot be null");
        Assert.notNull(sku, "Product sku cannot be null");
    ...
    private ReadableProductPrice readablePrice(
            ProductPrice price, StoreMerchantId store, LanguageCode language)
    ...
    public ReadableProductPrice get(
            String sku, Long productPriceId, StoreMerchantId store, LanguageCode language) {
