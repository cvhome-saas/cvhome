...
public class ProductVariantGroupFacadeImpl implements ProductVariantGroupFacade {
    ...
    /*
        ...
        @Override
        public void removeImage(Long imageId, Long productVariantGroupId, StoreMerchantId store) {
            ...
            try {
                contentService.removeFile(Constants.SLASH + store + Constants.SLASH + productVariantGroupId, FileContentType.VARIANT, image.getProductImage());
