...
public class PersistableProductPriceMapper
    ...
    public PersistableProductPriceMapper(
            ProductService productService, ProductAvailabilityService productAvailabilityService) {
    ...
    public ProductPrice convert(
            PersistableProductPrice source, StoreMerchantId store, LanguageCode language) {
    ...
    public ProductPrice merge(
        ...
        try {
            ...
            destination.setDescriptions(
                    this.getProductPriceDescriptions(destination, source.getDescriptions()));
