...
public class ProductVariantServiceImpl extends SalesManagerEntityServiceImpl<Long, ProductVariant>
    ...
    public Page<ProductVariant> getByProductId(StoreMerchantId store, Product product, LanguageCode language,
                                               Pageable pageable) {
        return pageableProductVariantRepositoty.findByProductId(store, product.getId(), pageable);
    }

    @Override
    public List<ProductVariant> getByProductId(StoreMerchantId store, Product product, LanguageCode language) {
