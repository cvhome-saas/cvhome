...
/**
 * Create a list of option and option value in order to accelerate and prepare product
 * attribute creation
 *
 * @author carlsamson
 */
...
@Table(name = "PRODUCT_OPTION_SET",
		uniqueConstraints = { @UniqueConstraint(columnNames = { "STORE_MERCHANT_ID", "PRODUCT_OPTION_SET_CODE" }) })
@Getter
@Setter
public class ProductOptionSet extends SalesManagerEntity<Long, ProductOptionSet> {
	...
	@TableGenerator(name = "TABLE_GEN", table = "SM_SEQUENCER", pkColumnName = "SEQ_NAME",
			valueColumnName = "SEQ_COUNT", pkColumnValue = "PRODUCT_OPTION_SET_SEQ_NEXT_VAL",
