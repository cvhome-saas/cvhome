...
public class ReadableProductPopulator extends AbstractDataPopulator<Product, StoreMerchantId, ReadableProduct> {
	...
	public ReadableProduct populate(Product source, ReadableProduct target, StoreMerchantId store,
		...
		try {
			...
			if (source.getManufacturer() != null) {
				...
				com.asrevo.cvhome.catalog.model.manufacturer.ManufacturerDescription d = new com.asrevo.cvhome.catalog.model.manufacturer.ManufacturerDescription();
				...
				if (!CollectionUtils.isEmpty(attributes)) {
					...
					for (ProductAttribute attribute : attributes) {
						...
						if (attribute.isAttributeDisplayOnly()) { // read only attribute =
							...
							com.asrevo.cvhome.catalog.model.product.attribute.ProductOptionValueDescription valueDescription = new com.asrevo.cvhome.catalog.model.product.attribute.ProductOptionValueDescription();
					...
					if (!CollectionUtils.isEmpty(prices)) {
						...
						if (pr.isPresent()) {
							...
							Optional<ProductPriceDescription> d = pr.get()
								...
								.findFirst();
							if (d.isPresent()) {
								com.asrevo.cvhome.catalog.model.product.ProductPriceDescription priceDescription = new com.asrevo.cvhome.catalog.model.product.ProductPriceDescription();
	...
	private ReadableProductProperty createProperty(ProductAttribute productAttribute, LanguageCode language) {
		...
		if (descriptions != null && !descriptions.isEmpty()) {
			for (ProductOptionDescription optionDescription : descriptions) {
				com.asrevo.cvhome.catalog.model.product.attribute.ProductOptionValueDescription productOptionValueDescription = new com.asrevo.cvhome.catalog.model.product.attribute.ProductOptionValueDescription();
