...
@Getter
@AllArgsConstructor
public class ReadableProductPopulator
        extends AbstractDataPopulator<Product, StoreMerchantId, ReadableProduct> {
    ...
    public ReadableProduct populate(
            Product source, ReadableProduct target, StoreMerchantId store, LanguageCode language)
                            ...
                            if (podescriptions != null && !podescriptions.isEmpty()) {
                                ...
                                if (podescriptions.size() > 1) {
                                    for (ProductOptionValueDescription optionValueDescription :
                                            podescriptions) {
                                        if (Objects.equals(
                                                optionValueDescription.getLanguageCode(),
                                                language)) {
                                            podescription = optionValueDescription;
                                            break;
                                        }
    ...
    com.asrevo.cvhome.catalog.model.product.ProductDescription populateDescription(
