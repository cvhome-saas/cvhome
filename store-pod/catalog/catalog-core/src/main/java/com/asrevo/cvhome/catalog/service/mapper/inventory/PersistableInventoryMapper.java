...
public class PersistableInventoryMapper
    ...
    public ProductAvailability convert(
            PersistableInventory source, StoreMerchantId store, LanguageCode language) {
    ...
    public ProductAvailability merge(
        ...
        try {
            ...
            Set<ProductAvailability> existingAvailability =
                    Optional.ofNullable(product).map(Product::getAvailabilities).orElse(Set.of());
