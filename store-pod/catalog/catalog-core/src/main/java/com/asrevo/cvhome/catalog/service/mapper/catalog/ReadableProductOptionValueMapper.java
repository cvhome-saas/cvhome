...
public class ReadableProductOptionValueMapper
    ...
    public ReadableProductOptionValue merge(
        ...
        if (language == null) {
            List<com.asrevo.cvhome.catalog.model.product.attribute.ProductOptionValueDescription>
                    descriptions = new ArrayList<>();
            for (ProductOptionValueDescription desc : source.getDescriptions()) {
                com.asrevo.cvhome.catalog.model.product.attribute.ProductOptionValueDescription d =
    ...
    public ReadableProductOptionValue convert(
            ProductOptionValue source, StoreMerchantId store, LanguageCode language) {
