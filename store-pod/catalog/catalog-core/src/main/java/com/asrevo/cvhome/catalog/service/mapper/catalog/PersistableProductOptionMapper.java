...
public class PersistableProductOptionMapper
    ...
    public ProductOption convert(
            PersistableProductOptionEntity source, StoreMerchantId store, LanguageCode language) {
    ...
    public ProductOption merge(
        ...
        try {
            ...
            if (!CollectionUtils.isEmpty(source.getDescriptions())) {
                for (com.asrevo.cvhome.catalog.model.product.attribute.ProductOptionDescription
