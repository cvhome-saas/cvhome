...
public class ProductVariantGroupServiceImpl extends SalesManagerEntityServiceImpl<Long, ProductVariantGroup>
    ...
    @Override
    public Page<ProductVariantGroup> getByProductId(StoreMerchantId store, Long productId, LanguageCode language,
                                                    Pageable pageable) {
