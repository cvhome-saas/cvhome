...
public class ProductVariationServiceImpl extends SalesManagerEntityServiceImpl<Long, ProductVariation>
    ...
    @Autowired
    public ProductVariationServiceImpl(ProductVariationRepository productVariationSetRepository,
    ...
    @Override
    public Page<ProductVariation> getByMerchant(StoreMerchantId store, LanguageCode language, String code,
                                                Pageable pageable) {
