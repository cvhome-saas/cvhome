...
public class PersistableProductMapper implements Mapper<PersistableProduct, Product> {
    ...
    public PersistableProductMapper(
    ...
    public Product convert(
            PersistableProduct source, StoreMerchantId store, LanguageCode language) {
    ...
    public Product merge(
        ...
        try {
            ...
            if (!CollectionUtils.isEmpty(source.getDescriptions())) {
                for (com.asrevo.cvhome.catalog.model.product.ProductDescription description :
                        source.getDescriptions()) {
            ...
            if (!CollectionUtils.isEmpty(source.getCategories())) {
                for (com.asrevo.cvhome.catalog.model.category.Category categ :
                    ...
                    for (ProductVariant variant : destination.getVariants()) {
                        defaultAvailability =
                                this.defaultAvailability(
                                        new ArrayList<>(variant.getAvailabilities()));
                        break;
                    }
    ...
    private ProductVariant variant(
            Product product,
            PersistableProductVariant variant,
            StoreMerchantId store,
            LanguageCode language) {
