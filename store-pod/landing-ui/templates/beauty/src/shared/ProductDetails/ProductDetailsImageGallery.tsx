                    ...
                    >
                        {product.images.map((image) => (
                            <SwiperSlide key={image.id || image.imageUrl}>
                                <div
                                    className={cn(
                                        "relative aspect-[4/5] cursor-pointer rounded-2xl border-2 p-1 transition-all duration-300",
                                        mainImage.imageUrl === image.imageUrl
                                            ? "border-primary shadow-md scale-95"
                                            : "border-transparent opacity-70 hover:opacity-100 hover:border-primary/20"
                                    )}
