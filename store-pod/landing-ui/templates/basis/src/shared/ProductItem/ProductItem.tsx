                ...
                <Tooltip>
                    <TooltipTrigger asChild>
                        <Button
                            variant={null}
                            size={null}
                            className="w-10 h-10 rounded-full bg-linear-to-r from-secondary to-accent text-secondary-foreground hover:shadow-lg hover:shadow-secondary/50 transition-transform duration-300 hover:scale-110"
                ...
                <Tooltip>
                    <TooltipTrigger asChild>
                        <Button
                            variant={null}
                            size={null}
                            className="w-10 h-10 rounded-full bg-linear-to-r from-green-500 to-primary text-primary-foreground transition-transform duration-300 hover:scale-110 hover:shadow-lg hover:shadow-green-500/50 disabled:opacity-50 disabled:scale-100 disabled:shadow-none"
                    ...
                    <Tooltip>
                        <TooltipTrigger asChild>
                            <Button
                                variant={null}
                                size={null}
                                className="w-10 h-10 rounded-full bg-linear-to-r from-blue-500 to-primary text-primary-foreground hover:shadow-lg hover:shadow-blue-500/50 transition-transform duration-300 hover:scale-110"
                                asChild
                            >
