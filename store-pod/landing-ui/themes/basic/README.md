...
Dev: `http://org1-store1.spg-507f1f77.gateway.com/en?theme=basic` (and `/ar?theme=basic`). Merchant-selectable
as the `BASIC` enum value; not `STOREFRONT_FALLBACK_THEME`, which stays `starter`. Build guide:
