    ...
    return (
        <div className="tape bg-primary text-primary-foreground">
            <div className="mx-auto flex max-w-wide items-center gap-3 px-gutter py-1.5">
                <div className="min-w-0 flex-1 text-center font-display text-sm uppercase tracking-wide [&_a]:underline [&_a]:underline-offset-2" dangerouslySetInnerHTML={{__html: parseDescription(box.description)}}/>
                <button type="button" className="flex size-7 shrink-0 items-center justify-center hover:bg-primary-foreground/15" aria-label={t('ANNOUNCEMENT_DISMISS')} onClick={() => dismiss(box.code)}>
