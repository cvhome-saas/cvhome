 ...
 */
const display = Anton({subsets: ['latin', 'latin-ext'], weight: '400', display: 'swap', variable: '--font-fashion-display'});
const arabic = Changa({subsets: ['arabic', 'latin'], weight: ['800'], display: 'swap', variable: '--font-fashion-arabic'});
const sans = Rubik({subsets: ['latin', 'latin-ext', 'cyrillic', 'arabic'], weight: ['400', '500', '700'], display: 'swap', variable: '--font-fashion-sans'});
