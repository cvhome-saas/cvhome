...
/**
 * A plain HTML form: the credentials post to cua full-page (`data.action`), with the store and locale as hidden
 * inputs, and cua sends the browser on to the OAuth2 callback. No client JavaScript is in the hand-off.
 */
    ...
    return (
        <div className="flex flex-col gap-6">
            ...
            <form method="post" action={data.action} className="flex flex-col gap-4">
                ...
                <Button type="submit" size="lg" className="mt-2">{t('SUBMIT')}</Button>
            </form>
