    ...
    return (
        <div className={cn('relative', className)} onBlur={e => { if (!e.currentTarget.contains(e.relatedTarget as Node)) setFocused(false); }}>
            <label className="relative block">
                ...
                <Input type="search" role="combobox" aria-expanded={open} aria-autocomplete="list" value={query}
            ...
            {open && (
                <div role="listbox" className="absolute end-0 top-full z-50 mt-1 w-72 rounded-overlay border bg-popover p-1 text-popover-foreground shadow-overlay">
