...
/**
 * hunger — "The Letterbox Menu": the storefront as the folded takeaway menu posted through the door.
 * Numbered dish lines with dotted leaders and one tabular price column, section bands in the merchant's
 * second ink plate, state printed in outline. Tuned for a full restaurant menu ordered into the cart —
 * the platform has no reservation API, so this theme never pretends to book a table.
 */
export default defineTheme({
    id: 'hunger',
    name: 'Hunger',
    version: '1.0.0',
    description: 'The Letterbox Menu — a full restaurant menu, printed and ordered.',
    fonts,
