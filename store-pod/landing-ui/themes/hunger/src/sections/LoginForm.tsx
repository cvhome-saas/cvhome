        ...
        <div className="flex flex-col gap-6">
            ...
            <form method="post" action={data.action} className="flex flex-col gap-4">
                ...
                <div className="flex flex-col gap-1.5">
                    <Label htmlFor="username" className="press text-xs tracking-wide text-muted-foreground">{t('USERNAME')}</Label>
                    <Input id="username" name="username" autoComplete="username" required autoFocus/>
                </div>
                <div className="flex flex-col gap-1.5">
                    <Label htmlFor="password" className="press text-xs tracking-wide text-muted-foreground">{t('PASSWORD')}</Label>
                    <Input id="password" name="password" type="password" autoComplete="current-password" required/>
                </div>
                <button type="submit" className="fold plate h-12 justify-center border-primary px-8 text-base">{t('SUBMIT')}</button>
            </form>
