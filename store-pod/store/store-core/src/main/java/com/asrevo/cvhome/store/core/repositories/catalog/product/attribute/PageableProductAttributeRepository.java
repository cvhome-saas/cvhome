...
public interface PageableProductAttributeRepository
    ...
    Page<ProductAttribute> findByProductId(
            Integer storeId, Long productId, Integer languageId, Pageable pageable);
