...
@Getter
@Setter
public class ShoppingCartAttributeItem extends SalesManagerEntity<Long, ShoppingCartAttributeItem>
    ...
    @TableGenerator(
            ...
            pkColumnValue = "SHP_CRT_ATTR_ITM_SEQ_NEXT_VAL",
    ...
    @JsonIgnore @Transient private ProductAttribute productAttribute;
    ...
    public ShoppingCartAttributeItem(
            ShoppingCartItem shoppingCartItem, ProductAttribute productAttribute) {
