package com.asrevo.cvhome.store.core.repositories.reference.zone;
...
public interface ZoneRepository extends JpaRepository<Zone, Long> {
    ...
    @Query(
            "select z from Zone z left join fetch z.descriptions zd join fetch z.country zc where"
                    + " zc.isoCode=?1 and zd.language.id=?2")
