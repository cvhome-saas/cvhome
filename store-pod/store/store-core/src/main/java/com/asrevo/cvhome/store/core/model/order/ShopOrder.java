...
public class ShopOrder extends PersistableOrder implements Serializable {
    ...
    private List<ShoppingCartItem>
            shoppingCartItems; // overrides parent API list of shoppingcartitem
    private String cartCode = null;

    private OrderTotalSummary
            orderTotalSummary; // The order total displayed to the end user. That object will be
    // used when committing the order
