...
public interface OrderFacade {
    ...
    com.asrevo.cvhome.store.core.model.order.v0.ReadableOrderList getReadableOrderList(
    ...
    com.asrevo.cvhome.store.core.model.order.v0.ReadableOrder getReadableOrder(
