...
public class ShoppingCartApi {
    ...
    */
    ...
    public ResponseEntity<ReadableShoppingCart> modifyCart(
        ...
        try {
            ReadableShoppingCart cart =
                    shoppingCartFacade.modifyCart(code, promo, merchantStore, language);
    ...
    public ResponseEntity<ReadableShoppingCart> modifyCart(
        ...
        try {
            ReadableShoppingCart cart =
                    shoppingCartFacade.modifyCartMulti(
                            code, Arrays.asList(shoppingCartItems), merchantStore, language);
