...
public class PublishProductAspect {
    ...
    // save product
    @Pointcut("execution(* com.asrevo.cvhome.store.core.services.catalog.product.ProductService.saveProduct(com.asrevo.cvhome.store.core.entity.catalog.product.Product))")
    ...
    @After("execution(* com.asrevo.cvhome.store.core.services.catalog.product.ProductService.delete(com.asrevo.cvhome.store.core.entity.catalog.product.Product))")
    ...
    @Pointcut("execution(* com.asrevo.cvhome.store.core.services.catalog.product.variant.ProductVariantService.saveProductVariant(com.asrevo.cvhome.store.core.entity.catalog.product.variant.ProductVariant))")
    ...
    @After("execution(* com.asrevo.cvhome.store.core.services.catalog.product.variant.ProductVariantService.delete(com.asrevo.cvhome.store.core.entity.catalog.product.variant.ProductVariant))")
    ...
    @Pointcut("execution(* com.asrevo.cvhome.store.core.services.catalog.product.image.ProductImageService.saveOrUpdate(com.asrevo.cvhome.store.core.entity.catalog.product.image.ProductImage))")
    ...
    @After("execution(* com.asrevo.cvhome.store.core.services.catalog.product.image.ProductImageService.delete(com.asrevo.cvhome.store.core.entity.catalog.product.image.ProductImage))")
    ...
    @Pointcut("execution(* com.asrevo.cvhome.store.core.services.catalog.product.attribute.ProductAttributeService.saveOrUpdate(com.asrevo.cvhome.store.core.entity.catalog.product.attribute.ProductAttribute))")
    ...
    @After("execution(* com.asrevo.cvhome.store.core.services.catalog.product.attribute.ProductAttributeService.delete(com.asrevo.cvhome.store.core.entity.catalog.product.attribute.ProductAttribute))")
