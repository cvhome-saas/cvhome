...
@Tag(
        name =
                "Product attributes and options / options values management resource (Product"
...
public class ProductAttributeOptionApi {
    ...
    public @ResponseBody ReadableProductOptionEntity createOption(
        ...
        ReadableProductOptionEntity entity =
    ...
    @GetMapping(
            value = {"/private/product/option/unique"},
    ...
    @Operation(
            method = "GET",
            description = "Check if option code already exists",
            responses =
                    @ApiResponse(
                            content =
                                    @Content(
                                            schema = @Schema(implementation = EntityExists.class))))
    public ResponseEntity<EntityExists> optionExists(
    ...
    @ResponseStatus(HttpStatus.OK)
    @GetMapping(
            value = {"/private/product/option/value/unique"},
            produces = MediaType.APPLICATION_JSON_VALUE)
    @Parameters({
        @Parameter(
                name = "store",
    ...
    @Operation(
            method = "GET",
            description = "Check if option value code already exists",
            responses =
                    @ApiResponse(
                            content =
                                    @Content(
                                            schema = @Schema(implementation = EntityExists.class))))
    public ResponseEntity<EntityExists> optionValueExists(
            @RequestParam(value = "code") String code,
            @Parameter(hidden = true) @SecuredResource MerchantStore merchantStore,
            @Parameter(hidden = true) Language language) {
    ...
    public @ResponseBody ReadableProductOptionValue createOptionValue(
        ...
        ReadableProductOptionValue entity =
    ...
    @ResponseStatus(HttpStatus.CREATED)
    @RequestMapping(
            value = {"/private/product/option/value/{id}/image"},
            method = RequestMethod.POST)
    @Parameters({
        @Parameter(
                name = "store",
    ...
    @ResponseStatus(HttpStatus.OK)
    @RequestMapping(
            value = {"/private/product/option/{optionId}"},
    ...
    @ResponseStatus(HttpStatus.OK)
    @RequestMapping(
            value = {"/private/product/{id}/attributes"},
            method = RequestMethod.GET)
    @Parameters({
        @Parameter(
                name = "store",
    ...
    @ResponseStatus(HttpStatus.OK)
    @RequestMapping(
            value = {"/private/product/{id}/attribute/{attributeId}"},
            method = RequestMethod.GET)
    @Parameters({
        @Parameter(
                name = "store",
    ...
    public @ResponseBody ReadableProductAttributeEntity getAttribute(
        ...
        ReadableProductAttributeEntity entity =
                productOptionFacade.getAttribute(id, attributeId, merchantStore, language);
        return entity;
    }

    @ResponseStatus(HttpStatus.CREATED)
    @RequestMapping(
            value = {"/private/product/{id}/attribute"},
            method = RequestMethod.POST)
    @Parameters({
        @Parameter(
                name = "store",
    ...
    public @ResponseBody Entity createAttribute(
        ...
        ReadableProductAttributeEntity attributeEntity =
    ...
    @Operation(
            method = "POST",
            description = "Saves multiple attributes",
            summary = "application/json",
            responses =
                    @ApiResponse(
                            content =
                                    @Content(schema = @Schema(implementation = CodeEntity.class))))
