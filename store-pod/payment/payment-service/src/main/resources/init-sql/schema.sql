...
drop table if exists payment.sm_sequencer;
create sequence if not exists payment.transaction_seq increment by 50;
...
(
    ...
    primary key (store_merchant_id, payment_type),
