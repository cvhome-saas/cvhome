...
public class TempConfig {
    ...
    public ProductFileManager productFileManager(S3ProductContentFileManager s3ProductContentFileManager, StoreProductImageProperties imageProperties) {
        return new ProductFileManagerImpl(s3ProductContentFileManager, s3ProductContentFileManager, s3ProductContentFileManager, imageProperties.cropUploads(), imageProperties.height(), imageProperties.width());
    }
