...
VALUES ('65f023632bc46470c104b76f', false, '2024-03-31', '21f023932bc66470c104b76f', 'BASIS', 'LIGHT',
        ...
        '+966 50 123 4567',
        '11564', 'Riyadh Province', false, true, 'KG', 'SA', 'SAR', 'ar')
...
-- Box: agreement
-- Language: ar
font-size:0.9em; padding:5px;">باستخدامك للموقع، فإنك توافق على <a href="/terms">الشروط والأحكام</a>.</p>',
        'اتفاقية الاستخدام', 'اتفاقية الاستخدام',
        '', '', '', '', 8, 'ar')
on conflict (description_id) do nothing;
-- Language: en
font-size:0.9em; padding:5px;">By using the site, you agree to our <a href="/terms">Terms & Conditions</a>.</p>',
