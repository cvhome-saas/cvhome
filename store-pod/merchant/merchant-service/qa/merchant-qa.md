...
### LOAD-01 — Store reads and spg's domain lookup work with open-in-view off · critical · [verified]

- **Steps** — read the store; browse the storefront through spg, whose `domain_lookup` resolves the store on every
  request.
