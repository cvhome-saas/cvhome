...
/**
 * The layering of the inventory domain, enforced. Copy this class into a new service and change {@link #DOMAIN} — the
 * rules themselves live in {@link CvhomeArchitectureRules}.
 */
@AnalyzeClasses(packages = "com.asrevo.cvhome.inventory", importOptions = ImportOption.DoNotIncludeTests.class)
