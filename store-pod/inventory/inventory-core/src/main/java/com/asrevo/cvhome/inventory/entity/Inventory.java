...
public class Inventory extends SalesManagerEntity<Long, Inventory> implements Auditable, StoreScoped {
    ...
    @SequenceGenerator(name = "product_availability_seq", sequenceName = "product_availability_seq",
            allocationSize = SchemaConstant.ID_ALLOCATION_SIZE)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "product_availability_seq")
    private Long id;
