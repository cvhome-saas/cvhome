...
public class ReadableZonePopulator extends AbstractDataPopulator<Zone, StoreMerchantId, ReadableZone> {

    @Override
    public ReadableZone populate(Zone source, ReadableZone target, StoreMerchantId store, LanguageCode language) {
        if (target == null) {
