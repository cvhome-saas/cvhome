...
public class CustomerRepositoryImpl implements CustomerRepositoryCustom {
	...
	@Override
	public CustomerList listByStore(StoreMerchantId store, CustomerCriteria criteria) {
		...
		String whereQuery = " where c.storeMerchantId=:mId";
		...
		objectQ.setParameter("mId", store);
