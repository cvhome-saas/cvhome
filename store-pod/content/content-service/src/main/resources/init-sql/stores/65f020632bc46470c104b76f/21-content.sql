...
Languages: ['fr', 'en']
Starting content_id: 9
Starting description_id: 17
...
VALUES (9, 'about-us', 'PAGE', true, 1, true, '65f020632bc46470c104b76f')
...
INSERT INTO content.content (content_id, code, content_type,
                             link_to_menu, sort_order, visible, store_merchant_id)
VALUES (10, 'contact-us', 'PAGE', true, 2, true, '65f020632bc46470c104b76f')
on conflict (content_id) do nothing;
...
INSERT INTO content.content (content_id, code, content_type,
                             link_to_menu, sort_order, visible, store_merchant_id)
VALUES (11, 'terms', 'PAGE', false, 3, true, '65f020632bc46470c104b76f')
on conflict (content_id) do nothing;
...
INSERT INTO content.content (content_id, code, content_type,
                             link_to_menu, sort_order, visible, store_merchant_id)
VALUES (12, 'privacy', 'PAGE', false, 4, true, '65f020632bc46470c104b76f')
on conflict (content_id) do nothing;
...
VALUES (23, now(), now(),
        ...
        'politique-confidentialite', 12, 'fr')
on conflict (description_id) do nothing;
-- Language: en
INSERT INTO content.content_description (description_id, date_created, date_modified, description, name, title,
                                         meta_description, meta_keywords, meta_title, sef_url, content_id,
...
INSERT INTO content.content (content_id, code, content_type,
                             link_to_menu, sort_order, visible, store_merchant_id)
VALUES (13, 'location', 'PAGE', false, 5, true, '65f020632bc46470c104b76f')
on conflict (content_id) do nothing;
...
INSERT INTO content.content (content_id, code, content_type,
                             link_to_menu, sort_order, visible, store_merchant_id)
VALUES (14, 'faq', 'PAGE', false, 6, true, '65f020632bc46470c104b76f')
on conflict (content_id) do nothing;
...
INSERT INTO content.content (content_id, code, content_type,
                             link_to_menu, sort_order, visible, store_merchant_id)
VALUES (15, 'header-message', 'BOX', false, 7, true, '65f020632bc46470c104b76f')
on conflict (content_id) do nothing;
...
INSERT INTO content.content (content_id, code, content_type,
                             link_to_menu, sort_order, visible, store_merchant_id)
VALUES (16, 'agreement', 'BOX', false, 8, true, '65f020632bc46470c104b76f')
on conflict (content_id) do nothing;
