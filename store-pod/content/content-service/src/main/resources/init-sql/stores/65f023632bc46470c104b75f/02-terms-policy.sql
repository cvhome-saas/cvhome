...
VALUES (-5, now(), now(), '<h2>Terms of Service</h2><p>By placing an order on this store you agree to these terms. Orders are confirmed once payment is received; prices include applicable taxes unless stated otherwise. Returns are accepted within 14 days for unused items in their original packaging.</p>', 'Terms of Service', 'Terms of Service', '', '', '', '', -3, 'en')
on conflict (description_id) do nothing;

INSERT INTO content.content_description (description_id, date_created, date_modified, description,
                                          name, title, meta_description, meta_keywords, meta_title,
                                          sef_url, content_id, language_code)
VALUES (-6, now(), now(), '<h2>Conditions d''utilisation</h2><p>En passant commande sur cette boutique, vous acceptez les présentes conditions. Les commandes sont confirmées à réception du paiement ; les prix incluent les taxes applicables sauf mention contraire. Les retours sont acceptés sous 14 jours pour les articles non utilisés dans leur emballage d''origine.</p>', 'Conditions d''utilisation', 'Conditions d''utilisation', '', '', '', '', -3, 'fr')
on conflict (description_id) do nothing;
...
VALUES (-3, '65f023632bc46470c104b75f', -3, 1, 'LIVE', now(), null, '[{"language": "en", "title": "Terms of Service", "body": "<h2>Terms of Service</h2><p>By placing an order on this store you agree to these terms. Orders are confirmed once payment is received; prices include applicable taxes unless stated otherwise. Returns are accepted within 14 days for unused items in their original packaging.</p>"}, {"language": "fr", "title": "Conditions d''utilisation", "body": "<h2>Conditions d''utilisation</h2><p>En passant commande sur cette boutique, vous acceptez les présentes conditions. Les commandes sont confirmées à réception du paiement ; les prix incluent les taxes applicables sauf mention contraire. Les retours sont acceptés sous 14 jours pour les articles non utilisés dans leur emballage d''origine.</p>"}]', now(), 'seed')
