...
VALUES (25, 'about-us', 'PAGE', true, 1, true, '65f023632bc46470c104b75f')
...
INSERT INTO content.content (content_id, code, content_type,
                             link_to_menu, sort_order, visible, store_merchant_id)
VALUES (26, 'contact-us', 'PAGE', true, 2, true, '65f023632bc46470c104b75f')
on conflict (content_id) do nothing;
...
VALUES (52, now(), now(),
        ...
        'contactez-nous', 26, 'fr')
on conflict (description_id) do nothing;

-- Page: terms
INSERT INTO content.content (content_id, code, content_type,
                             link_to_menu, sort_order, visible, store_merchant_id)
VALUES (27, 'terms', 'PAGE', false, 3, true, '65f023632bc46470c104b75f')
on conflict (content_id) do nothing;
...
VALUES (54, now(), now(),
        ...
        'conditions-generales', 27, 'fr')
on conflict (description_id) do nothing;

-- Page: privacy
INSERT INTO content.content (content_id, code, content_type,
                             link_to_menu, sort_order, visible, store_merchant_id)
VALUES (28, 'privacy', 'PAGE', false, 4, true, '65f023632bc46470c104b75f')
on conflict (content_id) do nothing;
...
VALUES (56, now(), now(),
        ...
        'politique-confidentialite', 28, 'fr')
on conflict (description_id) do nothing;

-- Page: location
INSERT INTO content.content (content_id, code, content_type,
                             link_to_menu, sort_order, visible, store_merchant_id)
VALUES (29, 'location', 'PAGE', false, 5, true, '65f023632bc46470c104b75f')
on conflict (content_id) do nothing;
...
VALUES (58, now(), now(),
        ...
        'notre-emplacement', 29, 'fr')
on conflict (description_id) do nothing;

-- Page: faq
INSERT INTO content.content (content_id, code, content_type,
                             link_to_menu, sort_order, visible, store_merchant_id)
VALUES (30, 'faq', 'PAGE', false, 6, true, '65f023632bc46470c104b75f')
on conflict (content_id) do nothing;
...
INSERT INTO content.content (content_id, code, content_type,
                             link_to_menu, sort_order, visible, store_merchant_id)
VALUES (31, 'header-message', 'BOX', false, 7, true, '65f023632bc46470c104b75f')
on conflict (content_id) do nothing;
...
INSERT INTO content.content (content_id, code, content_type,
                             link_to_menu, sort_order, visible, store_merchant_id)
VALUES (32, 'agreement', 'BOX', false, 8, true, '65f023632bc46470c104b75f')
on conflict (content_id) do nothing;
