...
public enum AuditEventType {
    ...
    USER_IMPERSONATION_STARTED("user.impersonation.started", AuditCategory.SECURITY),
    USER_IMPERSONATION_ENDED("user.impersonation.ended", AuditCategory.SECURITY),
    USER_IMPERSONATION_DENIED("user.impersonation.denied", AuditCategory.SECURITY),
