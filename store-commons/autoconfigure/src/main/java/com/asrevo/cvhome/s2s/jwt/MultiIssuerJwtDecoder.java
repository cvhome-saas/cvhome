 ...
 * It lazily initializes and caches a specific {@link JwtDecoder}
...
public class MultiIssuerJwtDecoder implements JwtDecoder {
     ...
     *                            {@link JwtDecoder} configured for that issuer.
    ...
    public MultiIssuerJwtDecoder(
            Set<String> supportedIssuerUris, Function<String, JwtDecoder> decoderFactory) {
