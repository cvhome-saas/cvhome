...
public record ManagerStorePreferences(Theme theme, LanguageCode defaultLanguage,
	...
	public static ManagerStorePreferences of(Map<Object, Object> request) {
		...
		Theme theme = Optional.ofNullable(request.get("theme"))
			.map(it -> Theme.valueOf(it.toString()))
			.orElseThrow(() -> new IllegalArgumentException("Theme cannot be null"));

		LanguageCode defaultLanguage = Optional.ofNullable(request.get("defaultLanguage"))
