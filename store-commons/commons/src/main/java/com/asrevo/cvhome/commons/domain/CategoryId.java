...
/**
 * The id of a category of a store's catalogue: what the brand rail and a listing's filter name.
 *
 * <p>
 ...
 * </p>
 */
@JsonDeserialize(using = CategoryId.Reader.class)
public record CategoryId(Long value) implements Identifier, KeyPart, Comparable<CategoryId> {

    private static final String KIND = "category id";
    ...
    public static CategoryId of(String text) {
        return new CategoryId(LongIds.parse(text, KIND));
    }
    ...
    static final class Reader extends StdDeserializer<CategoryId> {
        ...
        @Override
        public CategoryId deserialize(JsonParser p, DeserializationContext ctxt) throws JacksonException {
            return LongIds.read(p, ctxt, CategoryId.class, CategoryId::new);
        }
    }
}
