...
public class DynamicSslLoaderNettyCustomizer implements NettyServerCustomizer {
	...
	private final SSlProviderLoader slProviderLoader;
	...
	public DynamicSslLoaderNettyCustomizer(SSlProviderLoader slProviderLoader) {
	...
	public HttpServer apply(HttpServer httpServer) {
		return httpServer
				...
				.secure(sslContextSpec -> {
					sslContextSpec.sslContext(slProviderLoader.defaultSslProvider().getSslContext()).setSniAsyncMappings(this.asyncMapping);
